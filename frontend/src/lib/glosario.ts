...
export const GLOSARIO: { patron: RegExp; termino: string; definicion: string }[] = [
  ...
  { patron: /\bkappa\b/i, termino: 'Kappa', definicion: 'Medida de acuerdo entre dos evaluadores (el juez y una persona) corregida por el acuerdo que se daria por azar. 0,6 o más es sustancial.' },
  ...
  { patron: /prerregistr/i, termino: 'Prerregistro', definicion: 'Congelar por escrito, con fecha, la hipótesis, el protocolo y los criterios de exito antes de tener datos, para que nadie cambie las reglas después.' },
  { patron: /puerta de reproducci/i, termino: 'Puerta de reproducción', definicion: 'Antes de descubrir nada, Rosa tiene que reproducir tres análisis ya publicados dentro de una tolerancia. Si no puede, un resultado nuevo no se distingue de un error.' },
  ...
  { patron: /modelo de mundo/i, termino: 'Modelo de mundo', definicion: 'Lo que Rosa da por sabido en esta investigación, hecho a hecho, cada uno con su fuente y su página. Nada entra sin pasar por la verificación.' },
  { patron: /procedencia/i, termino: 'Procedencia', definicion: 'De donde salio cada cosa: que fuente, que página, que código, que ejecución. Es lo que permite comprobar a Rosa desde fuera.' },
  ...
  { patron: /sandbox/i, termino: 'Sandbox', definicion: 'El contenedor aislado y sin red donde Rosa ejecuta el código de análisis: no puede tocar el ordenador ni salir a internet.' },
