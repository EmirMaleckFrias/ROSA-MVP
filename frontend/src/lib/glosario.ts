...
export const GLOSARIO: { patron: RegExp; termino: string; definicion: string }[] = [
  ...
  { patron: /procedencia/i, termino: 'Procedencia', definicion: 'De donde salió cada cosa: que fuente, que página, que código, que ejecución. Es lo que permite comprobar a Rosa desde fuera.' },
